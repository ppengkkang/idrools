...
public class KieSpringBasics2Test {
    ...
    public static void setup() {
        context = new ClassPathXmlApplicationContext("beans-internal2.xml");
    }
    ...
    public void testKSessionExecution() throws Exception {
        StatelessKieSession ksession = (StatelessKieSession) context.getBean("ksessionX");
        assertNotNull(ksession);
        ...
        StatelessKieSession ksession2 = (StatelessKieSession) context.getBean("ksessionX");
